...
export default function Authenticated({user, children, classNames}: PropsWithChildren<Props>) {
    const [showingNavigationDropdown, setShowingNavigationDropdown] = useState(false);
    return (
        <div className="min-h-screen grid grid-rows-[80px_1fr]">
            <Head title="چارت ایمن آب"/>
            <nav className=" bg-white border-b border-gray-400 py-3 h-[80px]">
                            ...
                            <div className="ms-3 relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        <Dropdown.Link href={route('dashboard')}>داشبورد</Dropdown.Link>
